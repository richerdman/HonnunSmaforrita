# Toodler — Group 4
This repository contains the Toodler React Native app built with Expo. The app implements an in-memory Kanban-style project management prototype (boards → lists → tasks).
